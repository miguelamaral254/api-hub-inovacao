...
public class StartupMapperImpl implements StartupMapper {
    ...
    public StartupDTO toDto(Startup entity) {
        ...
        StartupDTO startupDTO = new StartupDTO( id, title, description, enabled, status, userId, cnpj, managerId, feedback, justification, createdDate, lastModifiedDate );
